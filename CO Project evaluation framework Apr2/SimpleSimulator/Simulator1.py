...
def r_type_splitting(str):
    if str[-15:-12] == "000":
        ...
        instruction = "and"
    r_type_implementation(instruction, str[-12:-7], str[-20:-15], str[-25:-20])
...
def i_type_splitting(str):
    if str[-15:-12] == "000":
        ...
        instruction = "sltiu"
    i_type_implementation(instruction, str[-12:-7], str[-20:-15], str[-32:-20])

def s_type_splitting(str):
    if str[-15:-12] == "010":
        instruction = "sw"
    s_type_implementation(instruction, str[::-25] + str[-12:-7], str[-20:-15], str[-25:-20])
...
def b_type_splitting(str):
    if str[-15:-12] == "000":
        ...
        instruction = "bgeu"
    b_type_implementation(instruction, str[-12] + str[-11:-5], str[-20:-15], str[-25:-20])
...
def u_type_splitting(str):
    if str[0:7] == "0110111":
        ...
        instruction = "auipc"
    u_type_implementation(instruction, str[-12:-7], str[-32:-12])
...
while True:
    ...
    elif line[-7:] in ["0000011", "0010011", "0011011", "0100011"]:
        i_type_splitting(line)
    elif line[-7:] == "0100011":
        s_type_splitting(line)
    elif line[-7:] == "1100011":
        b_type_splitting(line)
    elif line[-7:] in ["0110111", "0010111"]:
